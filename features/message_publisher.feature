Feature: message publisher
  ...
  Scenario: A publisher can create a new message on an existing channel, if authorized
    Given a publisher with id "899"
    And exists a channel with id "3333"
  ...
  Scenario: A publisher cannot create a new message on an existing channel, if not authorized
    Given a publisher with id "899"
    And exists a channel with id "3333"
  ...
  Scenario: A publisher cannot create a new message on a not existing channel
    Given a publisher with id "899"
    And  a channel with id "3333" doesn't exists
    When the publisher write the message "Hi guys"
    Then the publisher is informed that the channel doesn't exists

  Scenario: A publisher can delete a message in a channel
    Given a publisher with id "899"
